...
function showHelp() {
    ...
    if (lang === 'en') {
        ...
        console.log(`  ${chalk.bold.white('run edit')}                  ${chalk.gray('Edit app (interactive)')}`)
        console.log(`  ${chalk.bold.white('run delete')}                ${chalk.gray('Remove application (interactive)')}`)
        ...
        console.log(`  ${chalk.bold.white('run edit')}                  ${chalk.gray('Ubah aplikasi (interaktif)')}`)
        console.log(`  ${chalk.bold.white('run delete')}                ${chalk.gray('Hapus aplikasi (interaktif)')}`)
